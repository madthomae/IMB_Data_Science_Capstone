...
def get_pie(site_dropdown):
    ...
    if site_dropdown == 'ALL':
        pie_fig = px.pie(filtered_df, values='name size', 
        names='Launch Site', 
        title='Total Successful Launches for All Sites')
        return pie_fig
    else:
        filtered_dfs = spacex_df[spacex_df['Launch Site'] == site_dropdown].groupby('class').size().reset_index(name='class size')
        pie_fig = px.pie(filtered_dfs,
        values='class size', 
        names='class', 
        title='Total Successful vs Failed Launches for Site Selected')
        return pie_fig
...
def get_scatter(site_dropdown, slider_range):
    ...
    if site_dropdown == 'ALL':
        ...
        scat_dfs = scat_df[scat_df['Launch Site'] == site_dropdown]
        scat_fig = px.scatter(scat_dfs, x="Payload Mass (kg)", y="class", color="Booster Version Category",
                title='Correlation between Payload and Success for Site Selected') 
        return scat_fig
